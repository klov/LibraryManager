                            ...
                            <div class="form-horizontal">
                                <div class="row ">
                                            ...
                                            <div  class="col-md-10 block large-block" style="margin-bottom: 5px;">
                                                <table class="table table-bordered">
                                                    <tr ng-repeat=" p in pageList|orderBy:orderName():false:localeComparator" class="rows">
                                                        <td ng-click="ctrl.viewPage(p)"><spen ng-bind="p.name" ></spen></td>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <button class="btn btn-success center-block" ng-click="ctrl.formidBook()"><span>Показать книгу</span></button>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    ...
                                                    <input type="text"   class=" input-small form-control" readonly=true ng-model="ctrl.document.incomenumber" required="true" >
                                                </div>
                                                <div class=" col-md-3 input-group">
                                                    <label class="control-lable ">Дата входящего</label>
                                                    <div class=" input-group date form_date">
                                                        <input type='text'  class="form-control" readonly=true ng-model="ctrl.document.incomedate" required="true" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class=" col-md-3 input-group ">
                                                    ...
                                                    <div class=" input-group date form_date" >
                                                        <input type='text' class="form-control" readonly=true ng-model="ctrl.document.outcomedate" required="true"  />
                                                        <span class="input-group-addon" >
                                                            <span class="glyphicon glyphicon-calendar"></span>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="row">                                                    
                                                <div class=" col-md-5 ">
                                                    ...
                                                    <input type="text" class="input-small form-control" readonly=true  ng-model="ctrl.document.notice" required="true" >
                                                </div>
                                                <div class=" col-md-3 input-group ">
                                                    <label class="control-lable ">Дата извещения</label>
                                                    <div class=" input-group date form_date" >
                                                        <input type='text' class="form-control" readonly=true  ng-model="ctrl.document.noticedate" required="true"  />
                                                        <span class="input-group-addon" >
                                                            <span class="glyphicon glyphicon-calendar"></span>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="number" min="0" class="input-small form-control" readonly=true ng-model="ctrl.document.modification" required="true" >
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class=" col-md-2  ">
                                                    <label class="control-lable">Количество листов:</label>
                                                    <input type="number" min="0"  ng-model="ctrl.document.listcount" readonly=true  class="form-control " required="true" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
